...
create_line+="--network --network type=direct,source=enp4s0f0,model=virtio,source_mode=bridge --network type=direct,source=enp4s0f1,model=virtio,source_mode=bridge --network network=default "
